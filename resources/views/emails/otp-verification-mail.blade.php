...
@section('title', 'OTP Verification Mail')
...
@section('content')
    <div class="container text-center" style="max-width: 600px; margin: 0 auto;">
        ...
        <p>{{ __('Your OTP for verification is:') }}</p>
        ...
        <p class="mt-3">{{ __('This code will expire within 10 minutes. Please do not share it with anyone.') }}</p>
