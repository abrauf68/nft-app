<div class="fixed bottom-0 left-0 right-0 z-40">
    <div class="container bg-p2 px-6 py-3 rounded-t-2xl flex justify-around items-center dark:bg-p1">
        <a href="{{ route('frontend.home') }}" class="flex justify-center items-center text-center flex-col gap-1">
            <div class="flex justify-center items-center p-3 rounded-full {{ request()->routeIs('frontend.home') ? 'bg-p1 dark:bg-p2' : 'bg-white dark:bg-color10' }}">
                <i class="ph ph-house text-xl !leading-none {{ request()->routeIs('frontend.home') ? 'text-white' : 'dark:text-white' }}"></i>
            </div>
        ...
        <a href="{{ route('frontend.share.earn') }}" class="flex justify-center items-center text-center flex-col gap-1">
            <div class="flex justify-center items-center p-3 rounded-full {{ request()->routeIs('frontend.share.earn') ? 'bg-p1 dark:bg-p2' : 'bg-white dark:bg-color10' }}">
                <i class="ph ph-users-three text-xl !leading-none {{ request()->routeIs('frontend.share.earn') ? 'text-white' : 'dark:text-white' }}"></i>
            </div>
            <p class="text-xs text-white font-semibold dark:text-color10">
                Share & Earn
            </p>
